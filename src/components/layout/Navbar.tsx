...
export default function Navbar({
  ...
  return (
    <header className="sticky inset-x-0 top-0 z-50 flex w-full flex-wrap border-b border-gray-200 bg-white text-[13px] md:flex-nowrap md:justify-start dark:border-neutral-700 dark:bg-neutral-950">
